...
INSTALL_PKG_NAME = 'directflow_assist_cyphort'

setup(name=INSTALL_PKG_NAME,
      version=__version__,
      description='DirectFlow Assist for Cyphort Malware Defense System',
      ...
      long_description='''
Arista Networks, Inc.
DirectFlow Assist for Cyphort Malware Defense System
