...
OPERATING_MODE = MIRROR_MODE            # SHUNT_MODE, INLINE_MODE, MIRROR_MODE, MIRROR_AND_SHUNT_MODE
SYSLOG_TRANSPORT = UDP                  # options: UDP, TCP, SSL
ACCEPT_SYSLOG_MSGS_FROM_IP = ['1.2.3.4']   # only process msgs from these source IP addresses
...
SWITCH_INTERFACES_TO_FW_TAP = ['Ethernet1']    # switch interface(s) attached to firewall tap interface(s)
SWITCH_INTERFACES_TO_BE_MIRRORED = ['Ethernet2', 'Ethernet3']   # only rx/ingress traffic is mirrored, MIRROR_MODE only
