...
ACCEPT_SYSLOG_MSGS_FROM_IP = ['172.20.60.8']   # only process msgs from these source IP addresses
                                               # IP address of us113
...
# Zone_B interfaces
SWITCH_INTERFACE_B = 'Ethernet4'
SWITCH_INTERFACE_BF = 'Ethernet5'
SWITCH_INTERFACE_HA_BF = 'Ethernet6'             # optional: High-Availability to second firewall
FIREWALL_INTERFACE_BF = 'ethernet1/2'              # use same firewall intf name on AF and HA_AF, don't include sub-intf
