...
ACCEPT_SYSLOG_MSGS_FROM_IP = []         # IP addr is a string, e.g. '1.2.3.4'; ignore msgs from other IPs
...
# set Ethernet CoS and/or IP ToS fields in bypassed flows; key= app name string from syslog msg
# value= dict w/ key='COS' and/or 'TOS', value= integer; e.g.: 'web-browsing': {'COS': 2, 'TOS': 8}
COS_TOS_MARKING = {}
